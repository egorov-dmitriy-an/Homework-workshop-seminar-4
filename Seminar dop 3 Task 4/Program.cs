// Задача 4. Даны 4 точки a, b, c, d. Пересекаются ли векторы AB и CD? 
// Если пересекаются, то в какой четверти находится точка пересечения.
...
namespace ConsoleApp
{
    class Program
    {
        ...
        {
            Console.WriteLine("");
            Console.WriteLine("================ Семинар 3 Задача 4 Доп ================");
            ...
            void Position(double pos_x, double pos_y) // Определение четверти расположения точки пересечения
            {
                if(pos_x == 0 & pos_y == 0) Console.Write("Точка пересечения находится в центре координат");
                else if(pos_x == 0) Console.Write("Точка пересечения находится на оси Y");
                else if(pos_y == 0) Console.Write("Точка пересечения находится на оси X");
                else if(pos_x > 0 & pos_y > 0) Console.Write("Точка пересечения находится в первой четверти");
                else if(pos_x < 0 & pos_y > 0) Console.Write("Точка пересечения находится во второй четверти");
                else if(pos_x < 0 & pos_y < 0) Console.Write("Точка пересечения находится в третьей четверти");
                else if(pos_x > 0 & pos_y < 0) Console.Write("Точка пересечения находится в четвертой четверти");
            }
            ...
            else if(affil_AB == 1 && affil_CD == 1)
            {
                ...
                Position(inter_point_X, inter_point_Y);
                Console.WriteLine("");
            }
            else 
            {
